...
import { fetchReports, createReport, todayJST, formatReportDate, toHHMM } from '../lib/reports'
      ...
      <div className="reports-container">
        <div className="reports-toolbar">
          ...
          <div className="reports-toolbar-actions">
            {/* 自主検査表はハンバーガーメニューだけだと見つけにくいため、
                一覧の見える位置にも導線を置く（2026-08-04のご指摘を受けて追加） */}
            <button
              type="button"
              className="btn-plain"
              onClick={() => navigate('/reports/inspections')}
            >
              自主検査表
            </button>
            {!isOwner && (
                ...
                <li key={r.id}>
                  ...
                  >
                    <div className="report-row-date">
                      <span className="report-date">{formatReportDate(r.report_date)}</span>
